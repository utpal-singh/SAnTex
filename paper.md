...
The pressure and temperature dependence of elastic constants is mainly linear but can include non-linear effects that can be approximated up to second-order terms using a Taylor series expansion [@frisillo_measurement_1972; @kumazawa_elastic_1969-1; @mainprice_interpretation_1993; @faccenda_ecoman_2024].
