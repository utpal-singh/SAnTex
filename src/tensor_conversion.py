# function that converts 4th rank stiffness tensor to Voigt matrix notation
...
# function that converts Voigt matrix notation to 4th rank stiffness tensor
def voigt_to_tensor(voigt):
    # Initialize an empty 4x4x4x4 tensor
    tensor = [[[[0 for i in range(4)] for j in range(4)] for k in range(4)] for l in range(4)]
...
if __name__ == "__main__":
    ...
    tensor = [[[[1000.0 for i in range(4)] for j in range(4)] for k in range(4)] for l in range(4)]
