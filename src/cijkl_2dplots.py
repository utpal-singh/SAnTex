...
# Define a function to plot the phase velocities in 2d stereographic projection plots with velocity represented by colour
def plot_phase_velocity_2d(cijkl, rho):
    ...
    # Plot the scatter plot of x, y coordinates with colours c
    ax.scatter(x, y, c=c)
    # Set the axis labels and title
    ax.set_xlabel('x')
    ax.set_ylabel('y')
    ax.set_title('Phase velocity in 2d stereographic projection plots with velocity represented by colour')
    # Show the plot
    plt.show()
...
plot_phase_velocity_2d(cijkl, rho)
