...
# Define a function to generate a rotation matrix from Euler angles in ZYZ format
def euler_to_rotation(phi1, phi, phi2):
    # Convert angles from degrees to radians
    phi1 = np.radians(phi1)
    phi = np.radians(phi)
    phi2 = np.radians(phi2)
    # Define the rotation matrices around z, y and z axes
...
# Define a function to rotate a 3x3x3x3 stiffness tensor with Euler angles in ZYZ format
...
if __name__ == "__main__":
    ...
    gamma = -240    # Rotation angle around z axis in degrees
